...
class __Mustache_88c3eb72ca4f046e78f1b8117975667a extends Mustache_Template
{
...
';
        ...
        $blocksContext['day'] = array($this, 'blockAae4908e03e92f01a0b1705dd3588760');
        $blocksContext['url'] = array($this, 'block831596ddaf6cbde2745e4660f5b31066');
        $blocksContext['title'] = array($this, 'block1c882004ed0b8c7e2514534f032c872e');
        $blocksContext['nocontent'] = array($this, 'block36d7e0728fb3c91b9ae9e4672d9ef678');
        $blocksContext['content'] = array($this, 'block69978810ee87f7e5e0cea731399e4d89');
