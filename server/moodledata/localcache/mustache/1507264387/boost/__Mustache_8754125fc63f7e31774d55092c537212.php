...
class __Mustache_8754125fc63f7e31774d55092c537212 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= '" class="m-b-1" role="search">
';
...
';
        $buffer .= $indent . '    <input type="submit" class="btn btn-primary" id="user-filter-button" value=';
        // 'quote' section
        $value = $context->find('quote');
        $buffer .= $this->section65cc85c2a4b67440867c7d43f9e89745($context, $indent, $value);
        $buffer .= '>
';
        $buffer .= $indent . '</form>
';
...
';
    ...
    private function section28a7ae1bd530f30f4dc602ff2e64c61c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
    ...
    private function section65cc85c2a4b67440867c7d43f9e89745(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                // 'str' section
                $value = $context->find('str');
                $buffer .= $this->section28a7ae1bd530f30f4dc602ff2e64c61c($context, $indent, $value);
                $context->pop();
            }
        }
