...
class __Mustache_090bec0e9a0a608d0e2c00789c5bf54d extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionC4e1452bcd796c0b1252cf1b4ed188eb($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '            ';
        // 'icon' section
...
';
    ...
    private function sectionE1e77d4ea46d9f7d60ba06232c6b20eb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
...
';
    ...
    private function sectionC4e1452bcd796c0b1252cf1b4ed188eb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionE1e77d4ea46d9f7d60ba06232c6b20eb($context, $indent, $value);
                $buffer .= $indent . '                    <a href="';
